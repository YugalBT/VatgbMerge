...
{
    public partial class Pa41801
    {
        public short Pasetupkey { get; set; }
        public string Patsdefinedprompt1 { get; set; } = null!;
        public string Patsdefinedprompt2 { get; set; } = null!;
        public string Pacostdescts { get; set; } = null!;
        public string Patsdoccounter { get; set; } = null!;
        public short Patsunitcostfrom { get; set; }
        public short Patsprofittypefrom { get; set; }
        ...
        public byte PapostToPayroll { get; set; }
        public short PapostingPayrollCode { get; set; }
