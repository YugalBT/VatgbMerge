...
namespace Standing_Order_Vat_App.DAL.SKNAB
{
    public partial class Bm10300
    {
        ...
        public decimal TempAssembleQuantity { get; set; }
        public decimal TempExtendedAssembleQ { get; set; }
        public string TempLocationCode { get; set; } = null!;
        public decimal TempStockQuantity { get; set; }
        public decimal TempExtendedStockQuan { get; set; }
        ...
        public decimal TempExtendedStandardQ { get; set; }
        public decimal TempExistingQuantityA { get; set; }
        public short Incl { get; set; }
        public byte[] BmComponentOptions { get; set; } = null!;
