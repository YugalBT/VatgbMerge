...
{
    public partial class Pa10100
    {
        public short Paeqltrx { get; set; }
        public string Paeqlogno { get; set; } = null!;
        ...
        public byte[] PaelhdrErrors { get; set; } = null!;
        public byte[] PaeldistErrors { get; set; } = null!;
