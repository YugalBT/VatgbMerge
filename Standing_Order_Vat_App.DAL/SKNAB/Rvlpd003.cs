...
{
    public partial class Rvlpd003
    {
        public string Pmtdocid { get; set; } = null!;
        public string PmntDocDescription { get; set; } = null!;
        public string Chekbkid { get; set; } = null!;
        public byte SettleBeforeDueDate { get; set; }
        public byte Discountable { get; set; }
        public byte Collectable { get; set; }
        public byte DeferredDisc { get; set; }
